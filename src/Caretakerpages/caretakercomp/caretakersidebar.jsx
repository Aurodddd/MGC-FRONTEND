...
export default function caretakersidebar({ open, setOpen }) {
  ...
  { name: "Tenants", icon: <FaHouseUser />, path: "/caretakertenants" },
  { name: "Maintenance", icon: <GrVmMaintenance />, path: "/caretakermaintenance" },
  /*{ name: "Contract", icon: <TbContract />, path: "/caretakercontract" },*/
  { name: "Payment History", icon: <FaMoneyCheckAlt />, path: "/caretakerpayments" },
  { name: "Account Settings", icon: <FaCog />, path: "/caretakersettings" },
];
