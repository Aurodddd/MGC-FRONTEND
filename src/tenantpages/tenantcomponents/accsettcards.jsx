...
const handlePasswordSubmit = (e) => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#f7b094] to-[#dd7255] rounded-2xl w-full h-full px-4 sm:px-8 py-7 flex flex-col gap-6">
      ...
      {/* Form Card */}
      <div className="h-full bg-gradient-to-r from-[#fff3ec] to-[#f1c4aa] shadow-[5px_5px_0px_#330101] md:shadow-[10px_8px_0px_#330101] rounded-2xl px-4 md:px-10 py-6 flex flex-col gap-2 md:gap-4">
