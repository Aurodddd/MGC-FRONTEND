...
export default function AccsettCards() {
  ...
  const [formData, setFormData] = useState({
    username: "johnboesally",
    email: "johnboesally@example.com",
    password: "",
    tenants: "1",
    phone: "09123456789",
  });
  ...
  return (
    <div className="bg-gradient-to-r from-[#f7b094] to-[#dd7255] rounded-2xl px-12 py-8 flex flex-col gap-4 w-full h-full overflow-visible">
      {/* Header */}
      <div
      ...
      {/* Form Card */}
      <div className="h-auto bg-gradient-to-r from-[#fff3ec] to-[#f1c4aa] shadow-[15px_13px_0px_#330101] rounded-2xl px-16 py-8 flex flex-col gap-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Number of Tenants */}
          <div>
            <label className="block text-[#4b150d] font-bold mb-1">Number of Tenants</label>
            <select
              name="tenants"
              disabled={!isEditing}
