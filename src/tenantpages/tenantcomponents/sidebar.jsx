...
export default function Sidebar({ open, setOpen }) {
  ...
  { name: "Maintenance", icon: <GrVmMaintenance />, path: "/tenantmaintenance" },
  { name: "Contract", icon: <TbContract />, path: "/tenantcontract" },
  { name: "Payment History", icon: <FaMoneyCheckAlt />, path: "/tenantpayments" },
  { name: "Account Settings", icon: <FaCog />, path: "/tenantsettings" },
];
